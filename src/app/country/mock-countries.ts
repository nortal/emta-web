export let countries = [
  ...
  'CR|Costa Rica', 'CI|Cote D\'ivoire', 'HR|Croatia', 'CU|Cuba', 'CY|Cyprus', 'CZ|Czech Republic', 'DK|Denmark',
  'DJ|Djibouti', 'DM|Dominica', 'DO|Dominican Republic', 'TP|East Timor', 'EC|Ecuador', 'EG|Egypt', 'SV|El Salvador',
  ...
  'ID|Indonesia', 'IR|Iran, Islamic Republic Of', 'IQ|Iraq', 'IE|Ireland', 'IL|Israel', 'IT|Italy', 'JM|Jamaica',
  'JP|Japan', 'JO|Jordan', 'KZ|Kazakstan', 'KE|Kenya', 'KI|Kiribati', 'KP|Korea, Democratic People\'s Republic Of',
  'KR|Korea, Republic Of', 'KV|Kosovo', 'KW|Kuwait', 'KG|Kyrgyzstan', 'LA|Lao People\'s Democratic Republic',
  'LV|Latvia', 'LB|Lebanon', 'LS|Lesotho', 'LR|Liberia', 'LY|Libyan Arab Jamahiriya', 'LI|Liechtenstein',
  'LT|Lithuania', 'LU|Luxembourg', 'MO|Macau', 'MK|Macedonia, The Former Yugoslav Republic Of', 'MG|Madagascar',
  ...
  'MD|Moldova, Republic Of', 'MC|Monaco', 'MN|Mongolia', 'MS|Montserrat', 'ME|Montenegro', 'MA|Morocco',
  ...
  'PS|Palestinian Territory, Occupied', 'PA|Panama', 'PG|Papua New Guinea', 'PY|Paraguay', 'PE|Peru', 'PH|Philippines',
